...
var stepBar = {
    ...
    init : function(id, option){
        ...
        this.step = !isNaN(option.step) && option.step <= this.itemCount && option.step > 0 ? option.step : 0;
    ...
    stepInfoWidthFun : function(){
        if(this.itemCount > 0){
            ...
            this.itemWidth = Math.floor((this.barWidth * 0.8) / (this.itemCount - 1));
    ...
    _animate : function(){
        ...
        if(this.triggerStep < this.curStep){
            ...
            preClassPoint = "ui-stepNameColor";
            hindClass = "judge-stepSequence-hind";
            easing = this.stepEasingForward;
        } else {
            stepSequence_size.padding = "4 4";
            preClass = "judge-stepSequence-hind";
            hindClass = "judge-stepSequence-pre";
            hindClassWord = "judge-stepSequence-pre-words";
            hindClassPoint = "ui-stepSequence-point-back";
        }
        var preStep = this.curStep - 1;
        if(stepZero != 0){
            this.bar.find(".ui-stepInfo-words p:nth-child(" + this.curStep + ")").css("color","#2485D6");
        }
        this.bar.find(".ui-stepInfo:nth-child(" + this.curStep + ") .ui-stepSequence").removeClass(preClass).addClass(hindClass);
        this.bar.find(".ui-stepInfo:nth-child(" + this.curStep + ") .ui-stepSequence-point").addClass(hindClassPoint);
        this.bar.find(".ui-stepInfo:nth-child(" + preStep + ") .ui-stepSequence-point").removeClass(hindClassPoint);
